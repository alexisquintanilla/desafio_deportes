...
function edit() {
    ...
    axios.put(`/editar?nombre=${nombre}&precio=${precio}&newprecio=${newPrecio}`).then((data) => {
        alert('A sido modificado exitosamente el precio de : ' + nombre + '  valor anterior :' + precio + '  Nuevo valor : ' + newPrecio)
        getData()
    })
    $('#exampleModal').modal('hide')
}
